# EvacuTrace Rescue System - Quick Start Guide
...
```bash
pip install networkx numpy scipy matplotlib pymongo python-dotenv
```
...
- Run component tests: `python test_rescue_system.py`
